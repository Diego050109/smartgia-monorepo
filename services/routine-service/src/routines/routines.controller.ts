...
export class RoutinesController {
  ...
  @Get("active")
  getActive(@Headers() headers: any) {
    return this.routinesService.getActiveWeekly(this.getUserId(headers));
  }

  @Get("today")
  getToday(@Headers() headers: any) {
    return this.routinesService.getToday(this.getUserId(headers));
  }

  @Post("today/complete")
  completeToday(@Headers() headers: any) {
    return this.routinesService.completeToday(this.getUserId(headers));
  }
